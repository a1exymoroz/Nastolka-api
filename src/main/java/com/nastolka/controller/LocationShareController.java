...
public class LocationShareController {
    ...
    public ResponseEntity<LocationShareResponse> updateSharePermissions(
            @PathVariable Long locationId,
        ...
        return ResponseEntity.ok(
                locationShareService.updateSharePermissions(locationId, targetUsername, request, username));
    }
